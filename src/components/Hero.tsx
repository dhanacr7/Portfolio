    ...
    >
      ...
      <div className="container mx-auto px-4 z-10">
        ...
        >
          ...
          >
            {/* Rotating Data Ring */}
            <div className="absolute -inset-4 border border-dashed border-violet-500 rounded-full animate-[spin_10s_linear_infinite]" />
            <div className="absolute -inset-4 border border-t-2 border-t-violet-500 rounded-full animate-[spin_3s_linear_infinite]" />

            <div className="relative w-32 h-32 md:w-48 md:h-48 rounded-full overflow-hidden border-2 border-violet-500 shadow-[0_0_20px_rgba(127, 119, 221,0.3)] bg-black">
              <img
                src="/myphoto.jpeg"
                alt="Dhana Priyan"
              ...
              <div className="absolute inset-0 bg-[linear-gradient(rgba(127, 119, 221,0.1)_1px,transparent_1px)] bg-[size:100%_4px] pointer-events-none opacity-50" />
            </div>
          </motion.div>

          {/* 🔹 Name + Glitch */}
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-black mb-4 tracking-tight text-white">
            <span className="glitch-text hover:text-violet-400 transition-colors cursor-default">
              DHANA PRIYAN
            </span>
          </h1>

          <div className="text-xl md:text-2xl font-mono text-violet-400 mb-8 h-8">
          ...
          >
            {[
              ...
              <a
                ...
                className="group flex items-center gap-2 px-4 py-2 bg-white/5 border border-white/10 rounded hover:border-violet-500 hover:bg-violet-500 transition-all"
              >
                <social.icon className="w-5 h-5 text-gray-400 group-hover:text-violet-400 transition-colors" />
                <span className="text-xs font-bold text-gray-500 group-hover:text-violet-400 tracking-wider">
                  [{social.label}]
                </span>
              </a>
            ))}
          ...
          >
            <div className="flex flex-col items-center gap-2">
              <span className="text-[10px] uppercase tracking-[0.2em] text-violet-400">Scroll Down</span>
